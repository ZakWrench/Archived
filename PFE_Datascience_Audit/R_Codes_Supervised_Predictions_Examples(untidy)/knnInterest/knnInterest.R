...
dataset.subset <- read.csv("C:\\Users\\Fatihi\\Desktop\\data\\1LAB\\DataFinal\\Knn\\
                           scientifiqueeconomique5.csv", header = TRUE)
...
train.dataset_labels <- dataset.subset[dat.d,6]
test.dataset_labels <- dataset.subset[-dat.d,6]
...
sqrt(35000)
#So, we have 35000 observations in our training data set. The square root of 35000 is around 187.0829,
