dataset <- read.csv("C:\\Users\\Fatihi\\Desktop\\data\\1LAB\\DataFinal\\Knn\\userexperience50000row1-1000.csv", header = TRUE)
dataset.subset <- read.csv("C:\\Users\\Fatihi\\Desktop\\data\\1LAB\\DataFinal\\Knn\\userexperience50000row1-1000.csv", header = TRUE)
...
dataset.subset.n <- as.data.frame(lapply(dataset.subset[,1:3], normalize))
...
train.dataset_labels <- dataset.subset[dat.d,4]
test.dataset_labels <- dataset.subset[-dat.d,4]
