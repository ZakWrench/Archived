...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul 20 15:24:56 2022
    ...
    card_content = [
        ...
        dbc.CardBody(
            [
                ...
                html.H3('{0}{1}{2}'.format("$", sales_base, "M"), style = {'color':'#090059','textAlign':'center'}),a
                ]
            )  
        ]
    ...
    card_content1 = [
        dbc.CardBody(
            [
                ...
                html.H3('{0}{1}{2}'.format("$", holi_base, "M"), style = {'color':'#090059','textAlign':'center'}),b
                ]   
            )  
        ]
    ...
    card_content2 = [
        dbc.CardBody(
            [
                ...
                html.H3('{0}'.format( base_st_ct), style = {'color':'#090059','textAlign':'center'}),c
                ]   
            )  
        ]
